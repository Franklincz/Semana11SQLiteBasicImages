package com.example.semana11sqlitebasicimages;
...
private ArrayList<Plato>listaPlato;
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if(row==null){
            ...
            holder.txtNombre=(TextView)row.findViewById(R.id.txtNombr);
            holder.txtPrecio =(TextView)row.findViewById(R.id.txtPreci);
            holder.imgPlato =(ImageView)row.findViewById(R.id.imgPlat);
         row.setTag(holder);
